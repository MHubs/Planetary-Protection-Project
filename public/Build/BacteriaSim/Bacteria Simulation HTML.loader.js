function createUnityInstance(e, r, t) {
    ...
    function o(e) {
        var r = e.reason || e.error, t = r ? r.toString() : e.message || e.reason || "",
    ...
    function u() {
        ...
        c.preRun.push(function () {
            c.addRunDependency("dataUrl"), e.then(function (e) {
                var r = new DataView(e.buffer, e.byteOffset, e.byteLength), t = 0, n = "UnityWebData1.0\0";
    ...
    var h = {
        Module: c, SetFullscreen: function () {
            ...
            return new Promise(function (r, t) {
                c.shouldQuit = !0, c.onQuit = r, p.forEach(function (r) {
    ...
    return c.SystemInfo = function () {
        ...
        for (var r, t, n, o, a, s, i = navigator.userAgent + " ", d = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["Safari", "Safari"]], l = 0; l < d.length; ++l) if (t = e(d[l][0] + "[/ ](.*?)[ \\)]", i, 1)) {
            r = d[l][1];
            break
        }
        "Safari" == r && (t = e("Version/(.*?) ", i, 1)), "Internet Explorer" == r && (t = e("rv:(.*?)\\)? ", i, 1) || t);
        for (var u = [["Windows (.*?)[;)]", "Windows"], ["Android ([0-9_.]+)", "Android"], ["iPhone OS ([0-9_.]+)", "iPhoneOS"], ["iPad.*? OS ([0-9_.]+)", "iPadOS"], ["FreeBSD( )", "FreeBSD"], ["OpenBSD( )", "OpenBSD"], ["Linux|X11()", "Linux"], ["Mac OS X ([0-9_.]+)", "macOS"], ["bot|google|baidu|bing|msn|teoma|slurp|yandex", "Search Bot"]], c = 0; c < u.length; ++c) if (o = e(u[c][0], i, 1)) {
        ...
        return {
            ...
            hasWasmThreads: function () {
                var e = h && p && new WebAssembly.Memory({initial: 1, maximum: 1, shared: !0});
        ...
        function n() {
            function r(r) {
                if ("undefined" == typeof n.database) for (n.database = r, n.database || e("indexedDB database could not be opened"); n.queue.length;) {
                    var t = n.queue.shift();
            ...
            try {
                ...
                a.onupgradeneeded = function (e) {
                    var r = e.target.result.createObjectStore(i.name, {keyPath: "url"});
        ...
        function a(r) {
            this.cache = {enabled: !1}, r && (this.cache.control = r.cacheControl, this.cache.company = r.companyName, this.cache.product = r.productName), this.xhr = new XMLHttpRequest(r), this.xhr.addEventListener("load", function () {
                var r = this.xhr, t = this.cache;
        ...
        var s = {name: "UnityCache", version: 2}, i = {name: "XMLHttpRequest", version: 1},
        ...
        a.prototype.send = function (r) {
            ...
            return o.enabled = o.enabled && "arraybuffer" == n.responseType && !r, o.enabled ? void l.execute(i.name, "get", [o.result.url], function (r) {
                ...
                if (o.result = r, o.result.accessed = Date.now(), "immutable" == o.control) o.revalidated = !0, l.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' served from the indexedDB cache without revalidation"); else if (t(o.result.url) && (o.result.responseHeaders["Last-Modified"] || o.result.responseHeaders.ETag)) {
        ...
        c.SystemInfo.hasWebGL ? c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), c.startupErrorHandler = r, t(0), c.postRun.push(function () {
            t(1), delete c.startupErrorHandler, e(h)

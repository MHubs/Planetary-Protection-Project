...
export default class MoonGame extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.unityContext = new UnityContext({
            codeUrl: process.env.PUBLIC_URL + "/Build/Moon/HTML.wasm",
            frameworkUrl: process.env.PUBLIC_URL + "/Build/Moon/HTML.framework.js",
            dataUrl: process.env.PUBLIC_URL + "/Build/Moon/HTML.data",
            loaderUrl: process.env.PUBLIC_URL + "/Build/Moon/HTML.loader.js",
        });
        ...
        return (
            <div className="section section-examples" data-background-color="black">
                ...
                <Container>
                    <Row>
                        <Col sm="12">
                            <h2 className="title">Moon Cleanup Game!</h2>
